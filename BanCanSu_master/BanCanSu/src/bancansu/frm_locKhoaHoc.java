 ...
 * @author shamm
 */
public class frm_locKhoaHoc extends javax.swing.JFrame {
    ...
    private void cbbItemTenKH()
    {
        String sql = "select KhoaHoc from sinhvien group by KhoaHoc";
        this.connect();
        try{
    ...
    /**
     * Creates new form frm_locKhoaHoc
     */
    public frm_locKhoaHoc() {
        initComponents();
    ...
    {
        tbKhoaHoc.setAutoResizeMode(JTable.AUTO_RESIZE_NEXT_COLUMN);
        TableColumnModel colModel=tbKhoaHoc.getColumnModel();
    ...
    public void hienThiDuLieu(String khoaHoc)
    {
        ...
        sql += "and sinhvien.KhoaHoc='" + khoaHoc + "'";
    ...
    private void initComponents() {
        ...
        cbKhoHoc = new javax.swing.JComboBox<String>();
        ...
        tbKhoaHoc.setRowHeight(22);
        jScrollPane4.setViewportView(tbKhoaHoc);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(cbKhoHoc, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cbKhoHoc, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(bntLoc)
                    .addComponent(jLabel3))
                .addGap(18, 18, 18)
        ...
        jLabel1.setText("Lọc theo khóa học");
    ...
    private void bntLocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bntLocActionPerformed
        hienThiDuLieu(cbKhoHoc.getSelectedItem().toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_locKhoaHoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox<String> cbKhoHoc;
