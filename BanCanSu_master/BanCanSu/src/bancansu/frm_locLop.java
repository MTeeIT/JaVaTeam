 ...
 * @author shamm
 */
public class frm_locLop extends javax.swing.JFrame {
    ...
    {
        tbLop.setAutoResizeMode(JTable.AUTO_RESIZE_NEXT_COLUMN);
        TableColumnModel colModel=tbLop.getColumnModel();
    ...
    public void hienThiDuLieu(String tenLop)
    {
        DefaultTableModel model = (DefaultTableModel) tbLop.getModel();
        lamRongTable(model);
         //---------Lệnh Truy Vấn---------\\
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(cbCoVan, javax.swing.GroupLayout.PREFERRED_SIZE, 193, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_locLop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
